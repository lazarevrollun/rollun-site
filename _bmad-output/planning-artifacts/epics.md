...
- **FR-13** (Правка контента без разработчика) → **Epic 7** (текст/медиа/паспорт-слоты + ревалидация, Фаза 2) + **Epic 8** (каталожные коллекции Products/Brands/Shops + роли, Фаза 3).

*Все 13 FR покрыты. SM-1 (критерий пиксель-приёмки) → Epic 1 (Story 1.6). NFR-1/2/3 → Epic 1; NFR-4/5 → Epic 7. Cross-cutting UX-DR (a11y-пол UX-DR22, reduced-motion, empty-states UX-DR21, дефекты дизайна UX-DR24) заходят в AC соответствующих историй тех страниц/компонентов, где проявляются.*
